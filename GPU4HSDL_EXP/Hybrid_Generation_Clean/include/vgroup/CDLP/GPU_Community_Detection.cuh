...
void CDLP_GPU(int N, CSR_graph<int>& input_graph, std::vector<int>& res, int MAX_GROUP_SIZE, int max_iterations = 1000)
{
    ...
    cub::DeviceSegmentedSort::SortKeys(
        ...
        E, N, all_pointer, all_pointer + 1,0,false); // sort the labels of each vertex's neighbors
