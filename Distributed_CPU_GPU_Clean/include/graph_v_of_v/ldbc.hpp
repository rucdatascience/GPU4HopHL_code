...
class LDBC : public graph_v_of_v<weight_type> {
    public:
	// class initializer
    LDBC() : graph_v_of_v<weight_type>() {}
    LDBC(int n) : graph_v_of_v<weight_type>(n) {}
	LDBC(std::string directory, std::string name) : graph_v_of_v<weight_type>() {
