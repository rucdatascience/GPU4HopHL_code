...
double gpu_clean (graph_v_of_v<int>& input_graph, vector<vector<label>>& input_L, gpu_clean_info& info_gpu, vector<vector<hop_constrained_two_hop_label>>& res, int tc, int nid_vec_id);